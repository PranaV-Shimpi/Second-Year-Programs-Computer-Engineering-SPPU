...
iii)Academic record
Assume appropriate data members and member function
to accept required data & print bio-data.
...
Enter your address nashik
Enter your date of birth 3-4-99
Enter your gender(m/f) m

Enter professional details:
Enter your organization name newtech
Enter your project name newproj
Enter your project details energy solutions
Enter your years of experience 7

Enter academic details:
Enter your class(1st,distinction) distinction
Enter your year of passing out 2021
Enter your degree(BE,BTech) BE
...
Personal details:
        ...
        Gender:                m
Professional details:
        Organization name:     newtech
        Project name:          newproj
        Project details:       energy solutions
