/*Problem Statement:Implement all the functions of ADT using hashing data :Set of key value pairs ,keys are mapped to values ,keys must be comparable ,keys must be unique
