/*
Assignment No:01 		SE B	Roll no: 41
Title: Write a C++ program to draw a line using DDA line algorithm
	   and Bresenham's Algorithm. Inherit pixel class and use function
       Overloading.
 */
...
public:
	float x,y;
	int col;
	void drawpixel(float x, float y,int col)
	{
		putpixel(x,y,col);
	}
};
...
int main()
{
	...
	do
	{
		...
		switch(ch)
		{
			case 1: cout<<"DDA LINE ALGORITHM: ";
			...
			case 2: cout<<"BRESENHAM LINE ALGORITHM: ";
					cout<<"\nEnter first point(x1,y1): ";
					cin>>X1>>Y1;
					cout<<"\nEnter second point(x2,y2): ";
					cin>>X2>>Y2;
