/*
 * Assignment No: 	09	SE B	Roll No:41
 Problem Statement: Write a C++ program to implement reflection of 2D object about X-axis,Y axis and about
 X-Y axis. Also rotate object about arbitary point given by user.
 */
